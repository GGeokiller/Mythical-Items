import { Block, Direction, ItemUseBeforeEvent, system, Vector3, world } from "@minecraft/server";
import { MythicalItems } from "../../util/enum/ExternalItems";
import { addVector3, giveItem, isItemCooldownReady, getBlockFacelocation } from "../../util/functions/mainFunctions";
